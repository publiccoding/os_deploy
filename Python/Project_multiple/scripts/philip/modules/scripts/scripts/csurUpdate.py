...
def main():
	...
	if options.r and options.u:
		print(RED + "Options 'u' and 'r' cannot be used together; exiting program execution." + RESETCOLORS)
		exit(1)
	...
	try:
		...
		csurResourceDict = initialize.init(csurBasePath, logBaseDir, debug, programVersion, versionInformationLogOnly, updateOSHarddrives)
