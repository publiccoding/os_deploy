...
class ComputeNodeInventory:
	...
	def __getNICFirmwareInventory(self):
		nicCardModels = [] #This contains the list of NIC cards that were found, e.g. ['331FLR', 'HP560SFP'].
		count = 0
		...
		#Get a unique list of NIC card models from the bus list, which has contents such as: ['03:00.0 331FLR', '44:00.0 HP560SFP', '47:00.0 HP560SFP'].
	...
	def __getNicBusList(self):
		nicBusList = []
		busDict = {}
		modelCrossRefDict = {'NetXtreme BCM5719' : '331FLR', 'Intel Corporation 82599' : 'HP560SFP', 'Mellanox Technologies' : 'HP544QSFP'}
