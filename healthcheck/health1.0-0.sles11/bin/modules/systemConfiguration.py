# Embedded file name: /hp/support/health/bin/modules/systemConfiguration.py
import re
import subprocess
import time
import os
            ...
            if selection == '1':
                while 1:
                    ...
                    if startOver:
                        break
                    if 'Scale-up' in systemHWInfo:
                        if not scaleUpType in systemHWInfo:
                            if self.__confirmSelection({'Scale-up': systemHWInfo}):
                                ...
                                userInputsUpdates = 'Scale-up' not in systemHWInfo and userInputsUpdates + ' ' + 'Scale-up'
                            else:
